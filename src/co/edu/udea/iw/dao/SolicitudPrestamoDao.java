...
/**
 * Interface que define los metodos para acceder a la tabla tab_solicitudes_prestamo.
...
public interface SolicitudPrestamoDao {
	 ...
	 * @param id - Numero que identifica una solicitud.
	 ...
	 * @param solicitudPrestamo - DTO con los datos de la solicitud a guardar. 
	 * @throws NeuroLabDaoException cuando hay algun problema en la conexion.
	 */
	 ...
	 * @param solicitudPrestamo - DTO con los datos de la solicitud a modificar.
	 * @throws NeuroLabDaoException cuando hay algun problema en la conexion.
	 */
