...
public interface AdministradorDao {
	 ...
	 * @param id - Identificador, login o nombre de usuario de un administrador.
	 ...
	 * @param administrador - DTO con los datos del administrador a guardar. 
	 * @throws NeuroLabDaoException cuando hay algun problema en la conexion.
	 */
	 ...
	 * @param administrador - DTO con los datos del administrador a modificar.
	 * @throws NeuroLabDaoException cuando hay algun problema en la conexion.
	 */
