...
public interface InvestigadorDao {
	 ...
	 * @param id - Identificador, login o nombre de usuario de un investigador.
	 ...
	 * @param administrador - DTO con los datos del investigador a guardar. 
	 * @throws NeuroLabDaoException cuando hay algun problema en la conexion.
	 */
	 ...
	 * @param administrador - DTO con los datos del investigador a modificar.
	 * @throws NeuroLabDaoException cuando hay algun problema en la conexion.
	 */
