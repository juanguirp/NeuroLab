...
public interface DispositivoBl {
	 ...
	 * @param id - Numero que identifica al nuevo dispositivo.
	 * @param tipoDispositivo - Tipo o clase de dispositivo.
	 * @param disponible - Disponible o no para prestamo. 
	 * @param especificaciones - Caracteristicas del nuevo dispositivo.
	 * @param adminRegistrador - Identificador del administrador que registra el nuevo dispositivo en el sistema.
	 * @param fechaRegistro - Fecha en la que se registra el nuevo dispositivo.
	 ...
	 * @param id - Numero que identifica al dispositivo a eliminar.
	 * @throws NeuroLabDaoException cuando hay algun problema en la conexion.
	 */
